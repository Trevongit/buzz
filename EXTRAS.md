...
| **Visitor collab kit** | External Codex / Antigravity / Grok / **Goose CLI fork** — [`docs/visitor-collab.md`](docs/visitor-collab.md) · [`scripts/visitor/`](scripts/visitor/). Goose onboard: [`docs/goose-visitor-onboard.md`](docs/goose-visitor-onboard.md). Track A Grok (Agy-build): [`docs/agy-visitor-onboard.md`](docs/agy-visitor-onboard.md). Not ACP. Hermes/Nous Portal **parked**. |
